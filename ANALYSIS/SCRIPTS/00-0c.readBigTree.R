...
tr.big <- read.tree('../../2018-07.oaksAll.quickNdirty/workspace/tr.trial.v7-gtr.tre.export-withDeletions_noQuotes.tre')
...
write.tree(tr.big2, '../OUT/SUPPLEMENTS/DATA.S.full.tips.tree.2019-03-13.tre')
