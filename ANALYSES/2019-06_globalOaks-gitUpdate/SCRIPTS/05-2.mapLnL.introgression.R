...
do.chromes <- TRUE ## a nice picture that recapitulates what Andy's shown
lnLthreshold <- 4
...
## 5. chromosome map
if(do.chromes) {
  pdf(paste('../OUT/FIGS.AND.TABLES/FIGURE.chromoRadMap_lnL',
            lnLthreshold, '.pdf', sep = ''),
      11, 8.5, useDingbats = FALSE)
